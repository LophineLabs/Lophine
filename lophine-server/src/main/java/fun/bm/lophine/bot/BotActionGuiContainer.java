...
public class BotActionGuiContainer extends SimpleContainer {
    ...
    private static final ItemStack boarder = new ItemStack(Items.STAINED_GLASS_PANE.white());
    ...
    private static ItemStack createBackButtonItem() {
        ItemStack item = new ItemStack(Items.WOOL.red());
    ...
    private static ItemStack createHomeButtonItem() {
        ItemStack item = new ItemStack(Items.BED.red());
